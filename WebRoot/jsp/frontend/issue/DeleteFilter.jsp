                    ...
                    <table class="simpleform maxWidth">
                        ...
                        <tr>
                            <td class="fullyCentered simpleformfooter" colspan="2">
                                <input type="submit" class="spaced" title="按 Alt+S 提交" accesskey="S" value="删除" id="删除" name="删除" />
                                <input type="button" onclick="location.href='ManageFilters.jspa'" value="取消" name="ManageFilters.jspa" title="取消 (Alt + `)" accesskey="`" id="cancelButton" />
                            </td>
                        </tr>
                    </table>
                </form>
